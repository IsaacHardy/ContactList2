...
},{"./ajax_setup":1,"./router":7,"jquery":15,"underscore":16}],3:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, '__esModule', {
  value: true
});
var APP_ID = 'birc3lAkMGBI3K6Og4AK8YlfbaE1LpQmaE8g4gRQ';
var API_KEY = '3fjmoxr2SMVk2qqPReY6CnnGsM51ORGCKD36SnvV';
...
},{"../parse_data":3,"./contactModel":5,"backbone":14}],5:[function(require,module,exports){
'use strict';
...
},{"../parse_data":3,"backbone":14}],6:[function(require,module,exports){
'use strict';
...
var _contactCollection = require('./contactCollection');
...
exports.ContactModel = _contactModel2['default'];
exports.ContactCollection = _contactCollection2['default'];

},{"./contactCollection":4,"./contactModel":5}],7:[function(require,module,exports){
'use strict';
...
exports['default'] = _backbone2['default'].Router.extend({
  ...
  initialize: function initialize(appElement) {
    ...
    this.$el = appElement;
    this.collection = new _resources.ContactCollection();
    ...
    this.$el.on('click', '.contact-list-item', function (event) {
      ...
      _this.navigate('each/' + contactId, { trigger: true });
    });

    this.$el.on('click', '.back-btn', function (event) {
      var $button = (0, _jquery2['default'])(event.currentTarget);
      var route = $button.data('to');
      _this.navigate(route, { trigger: true });
    });

    this.$el.on('click', '.contact-add-item', function (event) {
      var $button = (0, _jquery2['default'])(event.currentTarget);
      var route = $button.data('to');
      _this.navigate(route, { trigger: true });
    });

    this.$el.on('click', '.contact-edit-item', function (event) {
      var $li = (0, _jquery2['default'])(event.currentTarget);
      var contactId = $li.data('contact-id');
      console.log($li);
      _this.navigate('edit/' + contactId, { trigger: true });
    });

    this.$el.on('click', '.submit-btn', function (event) {
      var contact = new _resources.ContactModel({
        FirstName: (0, _jquery2['default'])('.input-first').val(),
        LastName: (0, _jquery2['default'])('.input-last').val(),
        Email: (0, _jquery2['default'])('.input-email').val(),
        PhoneNumber: (0, _jquery2['default'])('.input-phone').val(),
        Location: (0, _jquery2['default'])('.input-location').val()
      });

      contact.save();

      var $submit = (0, _jquery2['default'])(event.currentTarget);
      var route = $submit.data('to');
      _this.navigate(route, { trigger: true });
    });
  },
  ...
  showList: function showList() {
    ...
    this.collection.fetch().then(function () {
      ...
      _this2.$el.html((0, _views.List)(_this2.collection.toJSON()));
    });
  },

  showEach: function showEach(id) {
    var _this3 = this;

    var contact = this.collection.get(id);

    if (contact) {
      this.$el.html((0, _views.Each)(contact.templateData()));
    } else {
      this.showSpinner();
      contact = this.collection.add({ objectId: id });
      contact.fetch().then(function () {
        _this3.$el.html((0, _views.Each)(contact.templateData()));
      });
    }
  },
  ...
  showAdd: function showAdd() {
    this.showSpinner();
    this.$el.html((0, _views.Add)(this.collection.toJSON()));
  },
  ...
  showEdit: function showEdit(id) {
    ...
    if (contact) {
      this.$el.html((0, _views.Edit)(contact.templateData()));
    } else {
      this.showSpinner();
      contact = this.collection.add({ objectId: id });
      contact.fetch().then(function () {
        _this4.$el.html((0, _views.Edit)(contact.templateData()));
      });
    }
  },
...
},{"./resources":6,"./views":11,"backbone":14,"jquery":15}],8:[function(require,module,exports){
"use strict";
...
},{"./add":8,"./each":9,"./edit":10,"./list":12,"./spinner":13}],12:[function(require,module,exports){
'use strict';
